...
var timesheetForm = function timesheetForm() {
  ...
  var visitResponse = $.ajax({
    ...
    */
    ...
    visitId.forEach(function (timesheetEl) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); // Construct body by extracting info from the form
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return $.ajax({
                type: "PATCH",
                url: "/api/timesheet/update-timesheet/".concat($("#jobId").val()),
                contentType: "application/json",
                data: JSON.stringify(requestBody)
              });
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return $.ajax({
                type: "DELETE",
                url: "/api/timesheet/delete-timesheet/".concat($("#jobId").val()),
                contentType: "application/json"
              });
